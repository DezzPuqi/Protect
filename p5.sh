...
banner() {
  ...
  echo -e "${RED}${BOLD}    <h1>⛔ NESTS LOCKDOWN ENABLED</h1>${NC}"
...
info "Menulis patch proteksi Nest (HTML 403 + only admin ID 1)..."
hr
...
class NestController extends Controller
{
    ...
    public function __construct(
        ...
        // 🔒 HARD LOCK: semua endpoint Nests hanya untuk Admin ID 1
...
<body>
  <div class="card">
    <div class="top">
      <div class="sig">⛔</div>
      <div>
        <h1 class="glow">ACCESS DENIED — NESTS MODULE LOCKED</h1>
...
Module: Admin / Nests<br/>
Rule: Only user_id == 1<br/>
Action: Request blocked
      </div>

      <div class="pillbar">
        <div class="pill">/admin/nests</div>
        <div class="pill">/admin/nests/new</div>
        <div class="pill">/admin/nests/view/*</div>
        <div class="pill">/admin/nests/* (update/delete)</div>
      </div>
    </div>
...
hr
ok "Proteksi Anti Akses Nest berhasil dipasang!"
